...
#+BEGIN_SRC emacs-lisp
  ...
  ;; (define-key evil-normal-state-map ",r" 'ido-recentf-open)
...
#+begin_src emacs-lisp :results none
(add-to-list 'load-path "/home/hersh/.emacs.d/predictive")
(add-to-list 'load-path "/home/hersh/.emacs.d/predictive/misc")
(add-to-list 'load-path "/home/hersh/.emacs.d/predictive/html")
(add-to-list 'load-path "/home/hersh/.emacs.d/predictive/texinfo")
(add-to-list 'load-path "/home/hersh/.emacs.d/predictive/latex")
(require 'predictive)
...
(defhydra hydra-major-latex(:color blue :hint nil)
  ...
  ("c" reftex-citation "Insert Citation")
...
(setq  mu4e-user-mail-address-list '("hersh@phy.duke.edu" "hersh.singh@duke.edu" "hs171@duke.edu"))
