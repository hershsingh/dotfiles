...
(use-package helm
  ...
  ;; Vim keybindings
  (define-key helm-map (kbd "C-j") 'helm-next-line) ; rebind tab to run persistent action
  (define-key helm-map (kbd "C-k") 'helm-previous-line) ; make TAB work in terminal
  (define-key helm-map (kbd "C-l") 'helm-next-source) ; make TAB work in terminal
  (define-key helm-map (kbd "C-h") 'helm-previous-source) ; make TAB work in terminal
